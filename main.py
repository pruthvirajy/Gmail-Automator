...
if __name__ == '__main__':
    ...
    parser.add_argument("--subject", help="Subject line of email, i.e. 'Software Architect'", required=True)
    parser.add_argument("--resume_path", help="Name of resume file in the directory, i.e. 'PruthvirajYerram2020.doc'", required=True)
